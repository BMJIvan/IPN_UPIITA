...
figure,surf(X,Y,tr_ip)
figure,surf(X,Y,tr_dp)

t1=table(tr_i);
t2=table(tr_d);
 ruta1='E:\semestre 5\sistemas neurodifusos\matlab\punto.txt';
 ruta2='E:\semestre 5\sistemas neurodifusos\matlab\puntosin.txt';